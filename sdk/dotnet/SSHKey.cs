...
{
    [OnepasswordResourceType("onepassword:index:SSHKey")]
    public partial class SSHKey : Pulumi.CustomResource
    {
        ...
        public SSHKey(string name, SSHKeyArgs args, CustomResourceOptions? options = null)
            : base("onepassword:index:SSHKey", name, args ?? new SSHKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SSHKey(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("onepassword:index:SSHKey", name, null, MakeResourceOptions(options, id))
        {
        }
