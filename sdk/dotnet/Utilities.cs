...
namespace Rocket.Surgery.OnePasswordNativeUnofficial
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/david-driscoll";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Rocket.Surgery.OnePasswordNativeUnofficial.version.txt");
    ...
    internal sealed class OnePasswordNativeUnofficialResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public OnePasswordNativeUnofficialResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
