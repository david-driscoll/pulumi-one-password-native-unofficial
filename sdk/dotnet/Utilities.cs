...
namespace Pulumi.OnePasswordNative
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.OnePasswordNative.version.txt");
    ...
    internal sealed class OnePasswordNativeResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public OnePasswordNativeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
