...
namespace Rocket.Surgery.OnePasswordNativeUnoffical
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Rocket.Surgery.OnePasswordNativeUnoffical.version.txt");
    ...
    internal sealed class OnePasswordNativeUnofficalResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public OnePasswordNativeUnofficalResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
