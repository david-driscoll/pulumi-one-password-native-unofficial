...
namespace Pulumi.Onepassword
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Onepassword.version.txt");
    ...
    internal sealed class OnepasswordResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public OnepasswordResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
