...
namespace Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical
{
    ...
    {
        [Output("address")]
        public Output<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.Identity.Outputs.AddressSection?> Address { get; private set; } = null!;
        ...
        public Output<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.Identity.Outputs.IdentificationSection?> Identification { get; private set; } = null!;

        [Output("internetDetails")]
        public Output<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.Identity.Outputs.InternetDetailsSection?> InternetDetails { get; private set; } = null!;
        ...
        public Pulumi.Output<IdentityItemGetAttachmentResult> GetAttachment(IdentityItemGetAttachmentArgs args)
            => Pulumi.Deployment.Instance.Call<IdentityItemGetAttachmentResult>("one-password-native-unoffical:index:IdentityItem/attachment", args ?? new IdentityItemGetAttachmentArgs(), this);
    }

    public sealed class IdentityItemArgs : Pulumi.ResourceArgs
    {
        [Input("address")]
        public Input<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.Identity.Inputs.AddressSectionArgs>? Address { get; set; }
        ...
        public Input<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.Identity.Inputs.IdentificationSectionArgs>? Identification { get; set; }

        [Input("internetDetails")]
        public Input<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.Identity.Inputs.InternetDetailsSectionArgs>? InternetDetails { get; set; }
