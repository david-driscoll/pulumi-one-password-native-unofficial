...
namespace Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical
{
    ...
    public partial class SoftwareLicenseItem : Pulumi.CustomResource
    {
        ...
        [Output("customer")]
        public Output<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.SoftwareLicense.Outputs.CustomerSection?> Customer { get; private set; } = null!;
        ...
        [Output("order")]
        public Output<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.SoftwareLicense.Outputs.OrderSection?> Order { get; private set; } = null!;

        [Output("publisher")]
        public Output<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.SoftwareLicense.Outputs.PublisherSection?> Publisher { get; private set; } = null!;
    ...
    public sealed class SoftwareLicenseItemArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("customer")]
        public Input<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.SoftwareLicense.Inputs.CustomerSectionArgs>? Customer { get; set; }
        ...
        [Input("order")]
        public Input<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.SoftwareLicense.Inputs.OrderSectionArgs>? Order { get; set; }

        [Input("publisher")]
        public Input<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.SoftwareLicense.Inputs.PublisherSectionArgs>? Publisher { get; set; }
