...
namespace Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical
{
    ...
    public partial class BankAccountItem : Pulumi.CustomResource
    {
        ...
        public Output<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.BankAccount.Outputs.BranchInformationSection?> BranchInformation { get; private set; } = null!;
    ...
    public sealed class BankAccountItemArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Rocket.Surgery.Pulumi.OnePasswordNativeUnoffical.BankAccount.Inputs.BranchInformationSectionArgs>? BranchInformation { get; set; }
