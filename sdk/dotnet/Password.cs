...
{
    [OnepasswordResourceType("onepassword:index:Password")]
    public partial class Password : Pulumi.CustomResource
    {
        ...
        public Password(string name, PasswordArgs args, CustomResourceOptions? options = null)
            : base("onepassword:index:Password", name, args ?? new PasswordArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Password(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("onepassword:index:Password", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Password Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Password(name, id, options);
        }
    }
