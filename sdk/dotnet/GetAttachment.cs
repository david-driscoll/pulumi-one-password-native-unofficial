...
namespace Pulumi.Onepassword
{
    public static class GetAttachment
    {
        public static Task<GetAttachmentResult> InvokeAsync(GetAttachmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAttachmentResult>("onepassword:index:GetAttachment", args ?? new GetAttachmentArgs(), options.WithDefaults());

        public static Output<GetAttachmentResult> Invoke(GetAttachmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetAttachmentResult>("onepassword:index:GetAttachment", args ?? new GetAttachmentInvokeArgs(), options.WithDefaults());
    }
