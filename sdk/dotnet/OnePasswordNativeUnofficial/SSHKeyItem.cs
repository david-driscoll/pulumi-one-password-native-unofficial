...
{
    [OnePasswordNativeUnofficialResourceType("one-password-native-unofficial:index:SSHKeyItem")]
    public partial class SSHKeyItem : Pulumi.CustomResource
    {
        ...
        private SSHKeyItem(string name, Input<string> id, SSHKeyItemState? state = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:SSHKeyItem", name, state, MakeResourceOptions(options, id))
        {
        }
