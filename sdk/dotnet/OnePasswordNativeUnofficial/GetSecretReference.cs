...
namespace Rocket.Surgery.OnePasswordNativeUnofficial
{
    public static class GetSecretReference
    {
        public static Task<GetSecretReferenceResult> InvokeAsync(GetSecretReferenceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetSecretReferenceResult>("one-password-native-unofficial:index:GetSecretReference", args ?? new GetSecretReferenceArgs(), options.WithDefaults());

        public static Output<GetSecretReferenceResult> Invoke(GetSecretReferenceInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetSecretReferenceResult>("one-password-native-unofficial:index:GetSecretReference", args ?? new GetSecretReferenceInvokeArgs(), options.WithDefaults());
    }
