...
{
    [OnePasswordNativeUnofficialResourceType("one-password-native-unofficial:index:PassportItem")]
    public partial class PassportItem : Pulumi.CustomResource
    {
        ...
        public PassportItem(string name, PassportItemArgs? args = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:PassportItem", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private PassportItem(string name, Input<string> id, PassportItemState? state = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:PassportItem", name, state, MakeResourceOptions(options, id))
        {
        }
