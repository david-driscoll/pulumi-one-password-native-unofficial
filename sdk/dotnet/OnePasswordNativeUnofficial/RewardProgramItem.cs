...
{
    [OnePasswordNativeUnofficialResourceType("one-password-native-unofficial:index:RewardProgramItem")]
    public partial class RewardProgramItem : Pulumi.CustomResource
    {
        ...
        public Output<Rocket.Surgery.OnePasswordNativeUnofficial.RewardProgram.Outputs.MoreInformationSection?> MoreInformation { get; private set; } = null!;
        ...
        private RewardProgramItem(string name, Input<string> id, RewardProgramItemState? state = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:RewardProgramItem", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RewardProgramItemArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Rocket.Surgery.OnePasswordNativeUnofficial.RewardProgram.Inputs.MoreInformationSectionArgs>? MoreInformation { get; set; }
