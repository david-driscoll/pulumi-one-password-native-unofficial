...
{
    [OnePasswordNativeUnofficialResourceType("one-password-native-unofficial:index:PasswordItem")]
    public partial class PasswordItem : Pulumi.CustomResource
    {
        ...
        public PasswordItem(string name, PasswordItemArgs? args = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:PasswordItem", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private PasswordItem(string name, Input<string> id, PasswordItemState? state = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:PasswordItem", name, state, MakeResourceOptions(options, id))
        {
        }
