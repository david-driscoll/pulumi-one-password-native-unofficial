...
{
    [OnePasswordNativeUnofficialResourceType("one-password-native-unofficial:index:MembershipItem")]
    public partial class MembershipItem : Pulumi.CustomResource
    {
        ...
        public MembershipItem(string name, MembershipItemArgs? args = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:MembershipItem", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }

        private MembershipItem(string name, Input<string> id, MembershipItemState? state = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:MembershipItem", name, state, MakeResourceOptions(options, id))
        {
        }
