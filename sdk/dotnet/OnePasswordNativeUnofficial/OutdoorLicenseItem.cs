...
{
    [OnePasswordNativeUnofficialResourceType("one-password-native-unofficial:index:OutdoorLicenseItem")]
    public partial class OutdoorLicenseItem : Pulumi.CustomResource
    {
        ...
        public OutdoorLicenseItem(string name, OutdoorLicenseItemArgs? args = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:OutdoorLicenseItem", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        ...
        private OutdoorLicenseItem(string name, Input<string> id, OutdoorLicenseItemState? state = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:OutdoorLicenseItem", name, state, MakeResourceOptions(options, id))
        {
        }
