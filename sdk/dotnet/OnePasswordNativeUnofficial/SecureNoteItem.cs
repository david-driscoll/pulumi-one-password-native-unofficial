...
{
    [OnePasswordNativeUnofficialResourceType("one-password-native-unofficial:index:SecureNoteItem")]
    public partial class SecureNoteItem : Pulumi.CustomResource
    {
        ...
        private SecureNoteItem(string name, Input<string> id, SecureNoteItemState? state = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:SecureNoteItem", name, state, MakeResourceOptions(options, id))
        {
        }
