...
{
    [OnePasswordNativeUnofficialResourceType("one-password-native-unofficial:index:EmailAccountItem")]
    public partial class EmailAccountItem : Pulumi.CustomResource
    {
        ...
        public Output<Rocket.Surgery.OnePasswordNativeUnofficial.EmailAccount.Outputs.ContactInformationSection?> ContactInformation { get; private set; } = null!;
        ...
        [Output("smtp")]
        public Output<Rocket.Surgery.OnePasswordNativeUnofficial.EmailAccount.Outputs.SmtpSection?> Smtp { get; private set; } = null!;
        ...
        private EmailAccountItem(string name, Input<string> id, EmailAccountItemState? state = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:EmailAccountItem", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EmailAccountItemArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Rocket.Surgery.OnePasswordNativeUnofficial.EmailAccount.Inputs.ContactInformationSectionArgs>? ContactInformation { get; set; }
        ...
        [Input("smtp")]
        public Input<Rocket.Surgery.OnePasswordNativeUnofficial.EmailAccount.Inputs.SmtpSectionArgs>? Smtp { get; set; }
