...
{
    [OnePasswordNativeUnofficialResourceType("one-password-native-unofficial:index:IdentityItem")]
    public partial class IdentityItem : Pulumi.CustomResource
    {
        [Output("address")]
        public Output<Rocket.Surgery.OnePasswordNativeUnofficial.Identity.Outputs.AddressSection?> Address { get; private set; } = null!;
        ...
        public Output<Rocket.Surgery.OnePasswordNativeUnofficial.Identity.Outputs.IdentificationSection?> Identification { get; private set; } = null!;

        [Output("internetDetails")]
        public Output<Rocket.Surgery.OnePasswordNativeUnofficial.Identity.Outputs.InternetDetailsSection?> InternetDetails { get; private set; } = null!;
        ...
        private IdentityItem(string name, Input<string> id, IdentityItemState? state = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:IdentityItem", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("address")]
        public Input<Rocket.Surgery.OnePasswordNativeUnofficial.Identity.Inputs.AddressSectionArgs>? Address { get; set; }
        ...
        public Input<Rocket.Surgery.OnePasswordNativeUnofficial.Identity.Inputs.IdentificationSectionArgs>? Identification { get; set; }

        [Input("internetDetails")]
        public Input<Rocket.Surgery.OnePasswordNativeUnofficial.Identity.Inputs.InternetDetailsSectionArgs>? InternetDetails { get; set; }
