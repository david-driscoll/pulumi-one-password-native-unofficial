...
{
    [OnePasswordNativeUnofficialResourceType("one-password-native-unofficial:index:MedicalRecordItem")]
    public partial class MedicalRecordItem : Pulumi.CustomResource
    {
        ...
        [Output("medication")]
        public Output<Rocket.Surgery.OnePasswordNativeUnofficial.MedicalRecord.Outputs.MedicationSection?> Medication { get; private set; } = null!;
        ...
        public MedicalRecordItem(string name, MedicalRecordItemArgs? args = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:MedicalRecordItem", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        ...
        private MedicalRecordItem(string name, Input<string> id, MedicalRecordItemState? state = null, CustomResourceOptions? options = null)
            : base("one-password-native-unofficial:index:MedicalRecordItem", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MedicalRecordItemArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("medication")]
        public Input<Rocket.Surgery.OnePasswordNativeUnofficial.MedicalRecord.Inputs.MedicationSectionArgs>? Medication { get; set; }
