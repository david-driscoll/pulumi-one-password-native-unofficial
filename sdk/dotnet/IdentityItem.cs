...
namespace Pulumi.OnePasswordNativeUnoffical
{
    ...
    {
        [Output("address")]
        public Output<Pulumi.OnePasswordNativeUnoffical.Identity.Outputs.AddressSection?> Address { get; private set; } = null!;
        ...
        public Output<Pulumi.OnePasswordNativeUnoffical.Identity.Outputs.IdentificationSection?> Identification { get; private set; } = null!;

        [Output("internetDetails")]
        public Output<Pulumi.OnePasswordNativeUnoffical.Identity.Outputs.InternetDetailsSection?> InternetDetails { get; private set; } = null!;
    ...
    {
        [Input("address")]
        public Input<Pulumi.OnePasswordNativeUnoffical.Identity.Inputs.AddressSectionArgs>? Address { get; set; }
        ...
        public Input<Pulumi.OnePasswordNativeUnoffical.Identity.Inputs.IdentificationSectionArgs>? Identification { get; set; }

        [Input("internetDetails")]
        public Input<Pulumi.OnePasswordNativeUnoffical.Identity.Inputs.InternetDetailsSectionArgs>? InternetDetails { get; set; }
