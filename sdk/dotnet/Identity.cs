...
namespace Pulumi.Onepassword
{
    ...
    {
        [Input("address")]
        public Input<Pulumi.Identity.Section.Inputs.Address>? Address { get; set; }

        [Input("identification")]
        public Input<Pulumi.Identity.Section.Inputs.Identification>? Identification { get; set; }

        [Input("internetDetails")]
        public Input<Pulumi.Identity.Section.Inputs.InternetDetails>? InternetDetails { get; set; }
