...
namespace Rocket.Surgery.OnePasswordNativeUnoffical
{
    ...
    public partial class SoftwareLicenseItem : Pulumi.CustomResource
    {
        ...
        [Output("customer")]
        public Output<Rocket.Surgery.OnePasswordNativeUnoffical.SoftwareLicense.Outputs.CustomerSection?> Customer { get; private set; } = null!;
        ...
        [Output("order")]
        public Output<Rocket.Surgery.OnePasswordNativeUnoffical.SoftwareLicense.Outputs.OrderSection?> Order { get; private set; } = null!;

        [Output("publisher")]
        public Output<Rocket.Surgery.OnePasswordNativeUnoffical.SoftwareLicense.Outputs.PublisherSection?> Publisher { get; private set; } = null!;
    ...
    public sealed class SoftwareLicenseItemArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("customer")]
        public Input<Rocket.Surgery.OnePasswordNativeUnoffical.SoftwareLicense.Inputs.CustomerSectionArgs>? Customer { get; set; }
        ...
        [Input("order")]
        public Input<Rocket.Surgery.OnePasswordNativeUnoffical.SoftwareLicense.Inputs.OrderSectionArgs>? Order { get; set; }

        [Input("publisher")]
        public Input<Rocket.Surgery.OnePasswordNativeUnoffical.SoftwareLicense.Inputs.PublisherSectionArgs>? Publisher { get; set; }
