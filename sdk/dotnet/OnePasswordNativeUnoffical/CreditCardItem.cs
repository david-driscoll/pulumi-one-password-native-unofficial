...
namespace Rocket.Surgery.OnePasswordNativeUnoffical
{
    ...
    public partial class CreditCardItem : Pulumi.CustomResource
    {
        ...
        public Output<Rocket.Surgery.OnePasswordNativeUnoffical.CreditCard.Outputs.ContactInformationSection?> ContactInformation { get; private set; } = null!;
    ...
    public sealed class CreditCardItemArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Rocket.Surgery.OnePasswordNativeUnoffical.CreditCard.Inputs.ContactInformationSectionArgs>? ContactInformation { get; set; }
