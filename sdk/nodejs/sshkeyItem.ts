...
export class SSHKeyItem extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SSHKeyItem {
        return new SSHKeyItem(name, undefined as any, { ...opts, id: id });
    }
