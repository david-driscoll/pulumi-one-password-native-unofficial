...
export function getSecureNote(args: GetSecureNoteArgs, opts?: pulumi.InvokeOptions): Promise<GetSecureNoteResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("one-password-native-unofficial:index:GetSecureNote", {
        "title": args.title,
        "uuid": args.uuid,
        "vault": args.vault,
    }, opts);
...
export interface GetSecureNoteArgs {
    /**
...
export function getSecureNoteOutput(args: GetSecureNoteOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSecureNoteResult> {
    return pulumi.output(args).apply(a => getSecureNote(a, opts))
}

export interface GetSecureNoteOutputArgs {
    /**
     * The title of the item to retrieve. This field will be populated with the title of the item if the item it looked up by its UUID.
     */
