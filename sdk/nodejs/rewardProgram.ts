...
export class RewardProgram extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RewardProgram {
        return new RewardProgram(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'onepassword:index:RewardProgram';

    /**
     * Returns true if the given object is an instance of RewardProgram.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RewardProgram {
    ...
    public readonly moreInformation!: pulumi.Output<outputs.rewardProgram.MoreInformation | undefined>;
     ...
     */
    constructor(name: string, args: RewardProgramArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RewardProgram.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface RewardProgramArgs {
    ...
    moreInformation?: pulumi.Input<inputs.rewardProgram.MoreInformationArgs>;
