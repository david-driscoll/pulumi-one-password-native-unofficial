...
export class DocumentItem extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DocumentItem {
        return new DocumentItem(name, undefined as any, { ...opts, id: id });
    }
