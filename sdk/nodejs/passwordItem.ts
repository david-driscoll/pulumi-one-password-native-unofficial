...
export class PasswordItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'one-password-native-unoffical:index:PasswordItem';
    ...
    getAttachment(args: PasswordItem.GetAttachmentArgs): pulumi.Output<PasswordItem.GetAttachmentResult> {
        return pulumi.runtime.call("one-password-native-unoffical:index:PasswordItem/attachment", {
            "__self__": this,
            "name": args.name,
        }, this);
    }
...
export namespace PasswordItem {
    /**
     * The set of arguments for the PasswordItem.getAttachment method.
     */
    ...
    /**
     * The results of the PasswordItem.getAttachment method.
     */
