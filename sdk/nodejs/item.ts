...
export class Item extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'one-password-native-unoffical:index:Item';
    ...
    getAttachment(args: Item.GetAttachmentArgs): pulumi.Output<Item.GetAttachmentResult> {
        return pulumi.runtime.call("one-password-native-unoffical:index:Item/attachment", {
            "__self__": this,
            "name": args.name,
        }, this);
    }
