...
export class OutdoorLicenseItem extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OutdoorLicenseItem {
        return new OutdoorLicenseItem(name, undefined as any, { ...opts, id: id });
    }
