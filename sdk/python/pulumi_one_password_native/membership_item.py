...
class MembershipItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(MembershipItem, __self__).__init__(
            'one-password-native:index:MembershipItem',
            resource_name,
            __props__,
            opts)
    ...
    def get_attachment(__self__, *,
                       name: pulumi.Input[str]) -> pulumi.Output['MembershipItem.GetAttachmentResult']:
        """
        ...
        __args__['name'] = name
        return pulumi.runtime.call('one-password-native:index:MembershipItem/attachment', __args__, res=__self__, typ=MembershipItem.GetAttachmentResult)
