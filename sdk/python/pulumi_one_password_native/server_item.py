...
class ServerItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ServerItem, __self__).__init__(
            'one-password-native:index:ServerItem',
            resource_name,
            __props__,
            opts)
    ...
    def get_attachment(__self__, *,
                       name: pulumi.Input[str]) -> pulumi.Output['ServerItem.GetAttachmentResult']:
        """
        ...
        __args__['name'] = name
        return pulumi.runtime.call('one-password-native:index:ServerItem/attachment', __args__, res=__self__, typ=ServerItem.GetAttachmentResult)
