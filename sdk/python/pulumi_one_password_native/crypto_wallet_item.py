...
class CryptoWalletItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(CryptoWalletItem, __self__).__init__(
            'one-password-native:index:CryptoWalletItem',
            resource_name,
            __props__,
            opts)
    ...
    def get_attachment(__self__, *,
        ...
        __args__['name'] = name
        return pulumi.runtime.call('one-password-native:index:CryptoWalletItem/attachment', __args__, res=__self__, typ=CryptoWalletItem.GetAttachmentResult)
