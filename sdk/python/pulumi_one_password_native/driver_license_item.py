...
class DriverLicenseItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(DriverLicenseItem, __self__).__init__(
            'one-password-native:index:DriverLicenseItem',
            resource_name,
            __props__,
            opts)
    ...
    def get_attachment(__self__, *,
        ...
        __args__['name'] = name
        return pulumi.runtime.call('one-password-native:index:DriverLicenseItem/attachment', __args__, res=__self__, typ=DriverLicenseItem.GetAttachmentResult)
