...
class SecureNoteItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(SecureNoteItem, __self__).__init__(
            'one-password-native:index:SecureNoteItem',
            resource_name,
            __props__,
            opts)
    ...
    def get_attachment(__self__, *,
        ...
        __args__['name'] = name
        return pulumi.runtime.call('one-password-native:index:SecureNoteItem/attachment', __args__, res=__self__, typ=SecureNoteItem.GetAttachmentResult)
