...
def get_item(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('one-password-native-unofficial:index:GetItem', __args__, opts=opts, typ=GetItemResult).value
...
def get_item_output(id: Optional[pulumi.Input[Optional[str]]] = None,
