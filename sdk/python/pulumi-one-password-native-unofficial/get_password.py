...
class GetPasswordResult:
    def __init__(__self__, attachments=None, category=None, fields=None, notes=None, password=None, references=None, sections=None, tags=None, title=None, urls=None, uuid=None, vault=None):
