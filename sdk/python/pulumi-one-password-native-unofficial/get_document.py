...
def get_document(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('one-password-native-unofficial:index:GetDocument', __args__, opts=opts, typ=GetDocumentResult).value
...
def get_document_output(id: Optional[pulumi.Input[Optional[str]]] = None,
