...
class IdentityItem(pulumi.CustomResource):
    ...
    def get_attachment(__self__, *,
                       name: pulumi.Input[str]) -> pulumi.Output['IdentityItem.GetAttachmentResult']:
        """
        ...
        __args__['name'] = name
        return pulumi.runtime.call('one-password-native-unoffical:index:IdentityItem/attachment', __args__, res=__self__, typ=IdentityItem.GetAttachmentResult)
