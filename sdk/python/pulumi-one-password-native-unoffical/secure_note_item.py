...
__all__ = ['SecureNoteItemArgs', 'SecureNoteItem']

@pulumi.input_type
class SecureNoteItemArgs:
    def __init__(__self__, *,
        ...
        if category is not None:
            pulumi.set(__self__, "category", 'Secure Note')
...
class SecureNoteItem(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SecureNoteItem resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: SecureNoteItemArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SecureNoteItem resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SecureNoteItemArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SecureNoteItemArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SecureNoteItemArgs.__new__(SecureNoteItemArgs)

            __props__.__dict__["category"] = 'Secure Note'
        ...
        super(SecureNoteItem, __self__).__init__(
            'one-password-native-unoffical:index:SecureNoteItem',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            vault: Optional[pulumi.Input[str]] = None) -> 'SecureNoteItem':
        """
        ...
        __props__ = _SecureNoteItemState.__new__(_SecureNoteItemState)
        ...
        __props__.__dict__["uuid"] = None
        return SecureNoteItem(resource_name, opts=opts, __props__=__props__)
    ...
    def get_attachment(__self__, *,
        ...
        __args__['name'] = name
        return pulumi.runtime.call('one-password-native-unoffical:index:SecureNoteItem/attachment', __args__, res=__self__, typ=SecureNoteItem.GetAttachmentResult)
