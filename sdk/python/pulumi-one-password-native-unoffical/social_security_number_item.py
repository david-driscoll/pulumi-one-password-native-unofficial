...
class SocialSecurityNumberItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["attachments", "fields", "number", "references", "sections"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(SocialSecurityNumberItem, __self__).__init__(
            'one-password-native-unoffical:index:SocialSecurityNumberItem',
            resource_name,
            __props__,
            opts)
    ...
    def get_attachment(__self__, *,
        ...
        __args__['name'] = name
        return pulumi.runtime.call('one-password-native-unoffical:index:SocialSecurityNumberItem/attachment', __args__, res=__self__, typ=SocialSecurityNumberItem.GetAttachmentResult)
