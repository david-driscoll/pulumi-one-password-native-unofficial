...
class DriverLicenseItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(DriverLicenseItem, __self__).__init__(
            'one-password-native-unoffical:index:DriverLicenseItem',
            resource_name,
            __props__,
            opts)
    ...
    def get_attachment(__self__, *,
                       name: pulumi.Input[str]) -> pulumi.Output['DriverLicenseItem.GetAttachmentResult']:
        """
        ...
        __args__['name'] = name
        return pulumi.runtime.call('one-password-native-unoffical:index:DriverLicenseItem/attachment', __args__, res=__self__, typ=DriverLicenseItem.GetAttachmentResult)
