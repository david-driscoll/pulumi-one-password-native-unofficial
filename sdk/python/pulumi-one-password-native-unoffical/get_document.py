...
class GetDocumentResult:
    def __init__(__self__, attachments=None, category=None, fields=None, notes=None, references=None, sections=None, tags=None, title=None, uuid=None, vault=None):
...
def get_document(title: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('one-password-native-unoffical:index:GetDocument', __args__, opts=opts, typ=GetDocumentResult).value
...
def get_document_output(title: Optional[pulumi.Input[Optional[str]]] = None,
