...
class PasswordItem(pulumi.CustomResource):
    ...
    def attachment(__self__, *,
                   name: pulumi.Input[str]) -> pulumi.Output['PasswordItem.AttachmentResult']:
        """
        ...
        __args__['name'] = name
        return pulumi.runtime.call('onepassword:index:PasswordItem/attachment', __args__, res=__self__, typ=PasswordItem.AttachmentResult)
