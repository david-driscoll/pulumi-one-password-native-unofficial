...
class PasswordItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(PasswordItem, __self__).__init__(
            'onepassword:index:PasswordItem',
            resource_name,
            __props__,
            opts)
    ...
    def get_attachment(__self__, *,
        ...
        __args__['name'] = name
        return pulumi.runtime.call('onepassword:index:PasswordItem/attachment', __args__, res=__self__, typ=PasswordItem.GetAttachmentResult)
