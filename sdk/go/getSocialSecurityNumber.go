...
func (o GetSocialSecurityNumberResultOutput) References() OutputReferenceMapOutput {
	return o.ApplyT(func(v GetSocialSecurityNumberResult) map[string]OutputReference { return v.References }).(OutputReferenceMapOutput)
}
