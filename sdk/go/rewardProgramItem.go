...
func NewRewardProgramItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("one-password-native-unofficial:index:RewardProgramItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRewardProgramItem(ctx *pulumi.Context,
	...
	var resource RewardProgramItem
	err := ctx.ReadResource("one-password-native-unofficial:index:RewardProgramItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
