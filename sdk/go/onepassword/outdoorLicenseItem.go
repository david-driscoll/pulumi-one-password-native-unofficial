...
func NewOutdoorLicenseItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("one-password-native-unoffical:index:OutdoorLicenseItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOutdoorLicenseItem(ctx *pulumi.Context,
	...
	var resource OutdoorLicenseItem
	err := ctx.ReadResource("one-password-native-unoffical:index:OutdoorLicenseItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
