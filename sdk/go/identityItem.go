...
func NewIdentityItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("one-password-native-unofficial:index:IdentityItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityItem(ctx *pulumi.Context,
	...
	var resource IdentityItem
	err := ctx.ReadResource("one-password-native-unofficial:index:IdentityItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
