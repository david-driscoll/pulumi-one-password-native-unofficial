...
func NewCryptoWalletItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("one-password-native-unofficial:index:CryptoWalletItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCryptoWalletItem(ctx *pulumi.Context,
	...
	var resource CryptoWalletItem
	err := ctx.ReadResource("one-password-native-unofficial:index:CryptoWalletItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
