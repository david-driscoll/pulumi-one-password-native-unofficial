...
func GetSSHKeyItem(ctx *pulumi.Context,
	...
	var resource SSHKeyItem
	err := ctx.ReadResource("one-password-native-unoffical:index:SSHKeyItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (r *SSHKeyItem) GetAttachment(ctx *pulumi.Context, args *SSHKeyItemGetAttachmentArgs) (SSHKeyItemGetAttachmentResultOutput, error) {
	out, err := ctx.Call("one-password-native-unoffical:index:SSHKeyItem/attachment", args, SSHKeyItemGetAttachmentResultOutput{}, r)
	if err != nil {
