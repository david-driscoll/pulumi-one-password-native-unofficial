...
func GetIdentity(ctx *pulumi.Context, args *GetIdentityArgs, opts ...pulumi.InvokeOption) (*GetIdentityResult, error) {
	...
	err := ctx.Invoke("one-password-native-unofficial:index:GetIdentity", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o GetIdentityResultOutput) Vault() OutputVaultOutput {
	return o.ApplyT(func(v GetIdentityResult) OutputVault { return v.Vault }).(OutputVaultOutput)
}
