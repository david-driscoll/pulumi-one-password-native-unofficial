...
func NewCreditCardItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("one-password-native-unofficial:index:CreditCardItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCreditCardItem(ctx *pulumi.Context,
	...
	var resource CreditCardItem
	err := ctx.ReadResource("one-password-native-unofficial:index:CreditCardItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
