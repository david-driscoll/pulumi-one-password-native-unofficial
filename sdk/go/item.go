...
func NewItem(ctx *pulumi.Context,
	...
	var resource Item
	err := ctx.RegisterResource("one-password-native-unofficial:index:Item", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetItem(ctx *pulumi.Context,
	...
	var resource Item
	err := ctx.ReadResource("one-password-native-unofficial:index:Item", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
