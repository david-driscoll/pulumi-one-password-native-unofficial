...
func NewAPICredentialItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("one-password-native-unofficial:index:APICredentialItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAPICredentialItem(ctx *pulumi.Context,
	...
	var resource APICredentialItem
	err := ctx.ReadResource("one-password-native-unofficial:index:APICredentialItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
