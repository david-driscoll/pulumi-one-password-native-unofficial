...
func GetCreditCard(ctx *pulumi.Context, args *GetCreditCardArgs, opts ...pulumi.InvokeOption) (*GetCreditCardResult, error) {
	...
	err := ctx.Invoke("one-password-native-unofficial:index:GetCreditCard", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The UUID of the item to retrieve. This field will be populated with the UUID of the item if the item it looked up by its title.
func (o GetCreditCardResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v GetCreditCardResult) string { return v.Id }).(pulumi.StringOutput)
}
