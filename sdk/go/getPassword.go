...
func (o GetPasswordResultOutput) References() OutputReferenceMapOutput {
	return o.ApplyT(func(v GetPasswordResult) map[string]OutputReference { return v.References }).(OutputReferenceMapOutput)
}
