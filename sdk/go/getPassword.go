...
func GetPassword(ctx *pulumi.Context, args *GetPasswordArgs, opts ...pulumi.InvokeOption) (*GetPasswordResult, error) {
	...
	err := ctx.Invoke("one-password-native-unofficial:index:GetPassword", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The UUID of the item to retrieve. This field will be populated with the UUID of the item if the item it looked up by its title.
func (o GetPasswordResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v GetPasswordResult) string { return v.Id }).(pulumi.StringOutput)
}
