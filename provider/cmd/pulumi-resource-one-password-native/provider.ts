...
export class Provider implements provider.Provider {
    ...
    async invoke(token: string, inputs: any): Promise<provider.InvokeResult> {
        ...
        switch (functionType) {
            case 'one-password-native:index:GetVault': return this.getVault(inputs);
            case 'one-password-native:index:GetSecretReference': return this.getSecretReference(inputs);
            case 'one-password-native:index:GetAttachment': return this.getAttachment(inputs);
